        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-offset-1">
                    <h4>Tổng phiếu thu: <span class="badge" style="background-color: orangered">@{{ new Intl.NumberFormat().format(val_pay_1 * 1 + val_pay_2 * 1 + val_pay_3 * 1 + val_pay_4 * 1) }}</span> VNĐ</h4>
                </div>
                <div class="col-md-3 col-md-offset-1">
                    <h4>Còn thiếu: <span class="badge" style="background-color: red">
